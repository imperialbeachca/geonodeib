...
COPY src /usr/src/geonodeib/
WORKDIR /usr/src/geonodeib
...
RUN chmod +x /usr/src/geonodeib/tasks.py \
    && chmod +x /usr/src/geonodeib/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonodeib/entrypoint.sh
